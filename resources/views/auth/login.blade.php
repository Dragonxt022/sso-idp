...
<body class="min-h-screen flex flex-col md:flex-row">
    ...
    <div id="background" class="hidden md:flex w-2/5 bg-cover bg-no-repeat bg-left opacity-0 transition-opacity duration-700 ease-in-out"
         style="background-image: url('{{ asset('frontend/img/meninas.png') }}')">
        <!-- Logo no canto -->
    ...
    <div class="flex w-full md:w-3/5 items-center justify-center h-screen mx-auto">
