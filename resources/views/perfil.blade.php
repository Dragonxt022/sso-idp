...
@section('content')
    <section class="max-w-2xl mx-auto">
        <div id="cards" class="flex flex-col gap-5 opacity-0 translate-y-4 transition-all duration-700">
            ...
            <div class="flex flex-row justify-between items-center">
                ...
                <img id="sso-icon" class="h-6 opacity-0 hover:opacity-30 transition-all duration-700 cursor-pointer" src="{{ asset('frontend/img/key.png') }}">
            </div>
    ...
    <div id="modal"
        ...
        <div id="modal-content"
            ...
            <h2 class="capitalize text-gray-500 text-xl font-semibold mb-8">Alterar senha</h2>
            ...
            <form action="{{ route('user.change-password') }}" method="POST">
                ...
                <div class="mb-4 relative">
                    ...
                    <input type="password" id="nova-senha" name="nova-senha" required
                        class="p-2 mt-1 w-full border rounded pr-10">
